...
<div id="mainContent" class="main-row fade">
  ...
  <div class="main-col">
    ...
    <form class="main-table table-testcase" data-ride="table" method="post" id='testcaseForm'>
      ...
      <?php $canBatchClone         = common::hasPriv('testcase', 'batchClone');?>
      ...
      <?php $canBatchAction       = ($canBatchEdit or $canBatchClone or $canBatchDelete or $canBatchReview or $canBatchChangeModule);?>
        ...
        <div class="table-actions btn-toolbar">
          <div class='btn-group dropup'>
            ...
            <ul class='dropdown-menu' id='moreActionMenu'>
              ...
              if($canBatchClone)
              {
                  $actionLink = $this->createLink('caselib', 'batchClone', "libID=$libID");
