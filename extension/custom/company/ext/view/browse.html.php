...
?>
<?php
include $this->app->getModuleRoot() . 'common/view/header.html.php';
...
<div id='mainMenu' class='clearfix'>
  ...
  <div class='btn-toolbar pull-right'>
    ...
    <?php else:?>
      ...
      ?>
      <?php common::printLink('company', 'syncInfo', "onlybody=yes", "<i class='icon'></i> " . $lang->company->syncInfo, '', "class='btn btn-primary create-user-btn ' data-toggle='modal' data-width='600'");?>
