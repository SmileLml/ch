...
$(document).ready(function()
{
    ...
    $.get(createLink('tree', 'ajaxGetXmindImport'),function(res)
    {
    ...
    $("#xmindmapSave").click(function(e)
    {
        ...
        if(data.mindList.length == 0)
        {
            alert(jsLng.caseNotExist);
            return;
        }

        $.post(createLink('tree', 'ajaxSaveXmindImport', 'viewType=' + viewType), data, function(res)
        {
...
ztmindmap.Wraper.prototype.toJson = function()
{
    ...
    {
        mindList.push(that.singleSceneToJson(data));
