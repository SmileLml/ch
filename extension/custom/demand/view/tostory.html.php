...
<div id="mainContent" class="main-content">
  <div class="center-block">
    <div class="main-header">
      <h2><?php echo $lang->demand->to . $lang->demand->storyTypeList[$type];?></h2>
        ...
        <tbody>
          <tr>
            ...
            <td colspan="2">
              ...
              <?php echo html::select('product', $products, '', "onchange='loadProduct(this.value);' class='form-control chosen control-product'");?>
          ...
          <tr>
            ...
            <td colspan="2">
              <div class='input-group' id='planIdBox'>
                <?php
                echo html::select('plan', '', '', "class='form-control chosen'");
                ?>
              </div>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td colspan='2' id='reviewerBox'>
              <div class="table-row">
                ...
                <div class="table-col">
                  <?php echo html::select('reviewer[]', $users, '', "class='form-control picker-select' multiple");?>
                </div>
                ...
                <?php else:?>
                <div class="table-col">
                  <?php echo html::select('reviewer[]', $users, '', "class='form-control picker-select' multiple required");?>                </div>
                <?php endif;?>
              </div>
            </td>
            ...
            <td colspan="2" class="sourceTd <?php echo $hiddenSource?> sourceBox">
              <div class="input-group">
                <div class="input-group">
                  ...
                  <?php echo html::select('source', $lang->story->sourceList, $demand->source, "class='form-control chosen'");?>
                  <span class='input-group-addon' id="sourceNoteBox"><?php echo $lang->story->sourceNote;?></span>
                  <?php echo html::input('sourceNote', $demand->sourceNote, "class='form-control' style='width:140px;'");?>
                </div>
              </div>
            </td>
            <?php endif;?>
              ...
              <div class='table-row'>
                <div class='table-col input-size'>
                  <div class="input-control has-icon-right">
                    <?php echo html::input('title', $demand->name, "class='form-control' required");?>
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-btn pri-selector" data-type="pri">
                      ...
                      <div class='dropdown-menu pull-right'>
                        <?php echo html::select('pri', (array)$priList, $demand->pri, "class='form-control' data-provide='labelSelector' data-label-class='label-pri'");?>
                      </div>
                    </div>
                    <?php endif;?>
                  </div>
                </div>
                <div class="table-col estimateBox">
                  <div class="input-group">
          ...
          <tr>
            ...
            <td colspan="4">
              ...
              <?php echo html::textarea('spec', $demand->desc, "rows='9' class='form-control kindeditor disabled-ie-placeholder' hidefocus='true' placeholder='" . htmlSpecialString($lang->story->specTemplate . "\n" . $lang->noticePasteImg) . "'");?>
            </td>
          </tr>
          <tr class="verifyBox">
          ...
          <tr>
            ...
            <td colspan='4'>
              <?php echo $this->fetch('misc', 'printFiles', array('files' => $demand->files, 'fieldset' => 'false', 'object' => $demand));?>
