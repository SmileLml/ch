...
<div id='mainMenu' class='clearfix'>
  <div class='btn-toolbar pull-left'>
    ...
    common::printLink('testtask', 'linkCase', "taskID=$taskID&type=all&param=0&recTotal=0&recPerPage=20&pageID=1&chproject=$chprojectID", "<span class='text'>" . $lang->testtask->allCases . '</span>', '', "class='btn btn-link {$allActive}'");
    ?>
...
<div class="cell show" id="queryBox" data-module='linkcase'></div>
<div id='mainContent'>
