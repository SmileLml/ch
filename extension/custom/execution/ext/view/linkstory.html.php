...
<div id="mainMenu" class="clearfix">
    <div class="btn-toolbar pull-left">
        <span class='btn btn-link btn-active-text'><span class='text'><?php echo ($this->app->tab == 'chteam' ? $project->name : $lang->execution->linkStory);?></span></span>
    </div>
    <?php if(!isonlybody()):?>
    ...
    <form class='main-table table-story' method='post' data-ride='table' id='linkStoryForm'>
        <table class='table table-fixed tablesorter' id='linkStoryList'>
            ...
            <tr>
                ...
                <th><?php echo $lang->story->affiliatedProjects;?></th>
            ...
            <?php foreach($allStories as $story):?>
                ...
                <tr>
                    ...
                    <td title='<?php echo $story->projectName?>'><?php echo $story->projectName;?></td>
                    <?php if($project->hasProduct):?>
                        <td class='text-left' title='<?php echo $products[$story->product]->name?>'><?php echo html::a($this->createLink('product', 'browse', "productID=$story->product&branch=$story->branch&browseType=&param=0&storyType=story&orderBy=&recTotal=0&recPerPage=20&pageID=1&projectID={$project->id}"), $products[$story->product]->name, '', "data-app=product");?></td>
                    <?php endif;?>
