    ...
    <form class='form-indicator main-form form-ajax' method='post' target='hiddenwin' id='dataform'>
      <table class='table table-form'>
        ...
        <tr>
          ...
          <td colspan='3'><?php echo html::select('chteam[]', $chteam, '', "class='form-control picker-select' multiple"); ?></td>
        </tr>
        ...
        <tr>
          ...
          <td id="plansBox">
            ...
            <?php echo html::select("plans[$planProductID][]", isset($productPlan) ? $productPlan : array(), isset($plan->id) && isset($productPlan[$plan->id]) ? $plan->id : '', "class='form-control chosen' multiple");?>
