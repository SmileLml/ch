$(function()
{
  $('.checkbox-primary.check-all').on('click', function()
  {
    if($(this).hasClass('checked'))
    {
      $('.checkbox-primary.check-all').removeClass('checked');
      $('.dtable-row').click().removeClass('is-checked');
      $('input[type="checkbox"][name="taskIdList[]"]').prop('checked', false);
      $('.table-footer .table-actions').hide();
    }
    else
    {
      $('.checkbox-primary.check-all').addClass('checked');
      $('.dtable-row').click().addClass('is-checked');
      $('input[type="checkbox"][name="taskIdList[]"]').prop('checked', true);
