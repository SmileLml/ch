$(function()
{
    ...
    $('#projectTaskForm').on('click', '[data-form-action]', function() {
        $('#projectTaskForm').attr('action', $(this).data('formAction')).submit();
    });

    $('#sidebar .btn[data-toggle="modal"]').hide();
});
...
function setStatistics()
{
    ...
    $.each(checkedIDList, function(index, id)
    {
        ...
        $('#projectTaskForm').append('<input type="hidden" name="taskIDList[]" value="' + id + '">');
    })
