...
<div id="mainMenu" class="clearfix">
  <div class="btn-toolbar pull-left">
    ...
    <?php
    foreach($lang->my->featureBar[$app->rawMethod]['projectapproval'] as $param => $name)
    {
  ...
  <?php $vars = "mode=$mode&type=$type&orderBy=%s&recTotal=$recTotal&recPerPage=$recPerPage&pageID=$pageID"; ?>
    <thead>
      <tr>
        ...
        <th class="text-<?php echo $field->position;?>" style="width:<?php echo $field->field == 'actions' ? '200px' : $width;?>">
        <?php
    ...
    <?php foreach($projectapprovalList as $data):?>
      <tr>
      <?php $index = 1;?>
      <?php foreach($fields as $field):?>
      ...
      <?php echo $this->flow->buildOperateMenu($flow, $data, 'browse');?>
      </td>
    </tr>
    <?php endforeach;?>
    </tbody>
...
<?php js::set('listName', 'projectapprovalList')?>
