    ...
    <form class="load-indicator main-form form-ajax" method='post' enctype='multipart/form-data' id='dataform'>
      <table class="table table-form">
        <tbody>
          ...
          <tr>
            <th><?php echo $lang->story->execution;?></th>
            <td colspan='2'><?php echo html::select('execution', $executions, $objectID, "class='form-control chosen'");?></td>
          </tr>
          <?php endif;?>
          <tr>
...
<?php js::set('storyType', $type);?>
<?php js::set('chproject', $chproject);?>
