  ...
  <div class="container">
    <div id="mainContent" class='main-content'>
      <div class='main-header'>
        <h2><?php echo $lang->testcase->importXmind; ?></h2>
      </div>
          ...
          <tr>
            ...
            <span style="display: inline-block; margin-bottom: 5px;" class='xmind-title'>
              ...
              <div style="margin-bottom: 2px;" class="row">
                ...
                <div class="col-sm-4">
                  <div class="input-group">
                    <span class="input-group-addon"><?php echo $lang->testcase->settingPrecondition; ?></span>
                    <?php echo html::input('precondition', $settings['precondition'], "class='form-control' placeholder='F'"); ?>
                  </div>
                </div>
              </div>
              <div class="row">
