...
<div id="mainContent" class="main-content">
  ...
  $stories['ditto'] = $lang->testcase->ditto;
  ?>
      ...
      <table class='table table-form table-fixed'>
        ...
        <tbody>
          ...
          <tr class='text-center'>
            ...
            <?php endif;?>
            <td class='text-left<?php echo zget($visibleFields, 'story', ' hidden')?>' style='overflow:visible'><?php echo html::select("story[$caseID]", $stories, $cases[$caseID]->story ? $cases[$caseID]->story : 'ditto', "class='form-control picker-select'");?></td>
