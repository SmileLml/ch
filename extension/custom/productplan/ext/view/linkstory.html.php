    ...
    <table class='table tablesorter'>
      <thead>
        <tr>
          ...
          <th class='c-module'><?php echo $lang->story->affiliatedProjects;?></th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class='c-name' title='<?php echo $story->projectName?>' class='text-left c-name'><?php echo $story->projectName;?></td>
