...
class myfile extends file
{
    ...
    public function docxInit()
    {
        ...
        if($this->app->tab == 'chteam')
        {
            ...
            $intances = $this->chproject->getIntances($this->post->executionID);
            $this->taskTree  = $this->execution->getTree($intances);
            $this->execution = $this->chproject->getById($this->post->executionID);
        }
        else
        {
