...
$canBatchAction = ($canBatchEdit or $canBatchClose or $canBatchChangeStage or $canBatchChangeModule or $canBatchChangePlan or $canBatchAssignTo or $canBatchUnlink or $canBatchImportToLib or $canBatchChangeBranch or $canBatchChangeRoadmap);
...
<div id="mainMenu" class="clearfix">
  ...
  <div class="btn-toolbar pull-right">
    ...
    else
    {
        ...
        if($this->app->tab != 'project' or $storyType != 'requirement') echo html::a($buttonLink, "<i class='icon-link'></i> $buttonTitle", '', "class='btn btn-primary $hidden' $dataToggle");
      ...
      <div class="table-footer">
        ...
        <div class="table-actions btn-toolbar">
          <div class='btn-group dropup'>
            ...
            ?>
            <?php if($canBatchEdit or $canBatchClose or $canBatchUnlink or $canBatchChangeStage or $canBatchChangeBranch) echo html::commonButton($lang->edit, "data-form-action='$actionLink' $disabled");?>
            <?php if($canBatchEdit or $canBatchClose or $canBatchUnlink or $canBatchChangeStage or $canBatchChangeBranch):?>
...
<?php if(in_array($config->edition, array('max', 'ipd')) and $config->vision == 'rnd'):?>
