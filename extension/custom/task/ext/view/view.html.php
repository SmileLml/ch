              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    {
                        common::printLink('execution', $method, "executionID={$task->execution}", $execution->name, '', 'data-app=execution');
                    }
                    else
                    {
                        echo $execution->name;
                ...
                <tr>
                  ...
                  ob_end_clean();
                  ?>
                  <td title='<?php echo $moduleTitle?>'>
                    <?php if($app->tab != 'chteam') echo $printModule?>
                    <?php if($app->tab == 'chteam') echo $moduleTitle?>
                  </td>
                </tr>
                <?php if($execution->lifetime != 'ops'):?>
                <tr class='nofixed'>
