      ...
      <table class="table table-form">
        <tbody>
          <tr>
            ...
            <td>
              <div class='input-group'>
                ...
                <?php echo html::select('dept', $depts, $app->user->dept, "class='form-control chosen'");?>
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td colspan='2'><?php echo nl2br(html::radio('acl', $lang->demandpool->aclList, 'open', '', 'block'));?></td>
          </tr>
          <tr>
