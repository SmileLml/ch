  ...
  <div class="main-col">
    ...
    <form class='main-table' method='post' id='demandpoolForm'>
      ...
      <table class='table has-sort-head' id='demandpoolList'>
        <thead>
          <tr>
            <th class='c-id'><?php common::printOrderLink('id', $orderBy, $vars, $lang->demandpool->id);?></th>
            <th><?php common::printOrderLink('name', $orderBy, $vars, $lang->demandpool->name);?></th>
            <th class='w-100px'><?php common::printOrderLink('status', $orderBy, $vars, $lang->demandpool->status);?></th>
            <th class='w-350px'><?php common::printOrderLink('dept',  $orderBy, $vars, $lang->demandpool->dept);?></th>
            <th class='w-120px'><?php common::printOrderLink('owner',  $orderBy, $vars, $lang->demandpool->owner);?></th>
            <th class='w-120px'><?php common::printOrderLink('createdBy',   $orderBy, $vars, $lang->demandpool->createdBy);?></th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td title='<?php echo zget($depts, $demandpool->dept, '');?>'><?php echo zget($depts, $demandpool->dept, '');?></td>
            <td><?php echo zget($users, $demandpool->owner, '');?></td>
            <td><?php echo zget($users, $demandpool->createdBy, $demandpool->createdBy);?></td>
            <td class='c-actions'>
              <?php
              common::printIcon('demandpool', 'edit', "demandpoolID=$demandpool->id", $demandpool, 'list');
              common::printIcon('demandpool', 'close', "demandpoolID=$demandpool->id", $demandpool, 'list', 'off', '', 'iframe', true);
