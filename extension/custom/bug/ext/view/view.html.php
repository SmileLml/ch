            ...
            <table class='table table-data'>
              <tbody>
                <tr>
                  ...
                  <td><?php if($bug->project) echo html::a($this->createLink('project', 'view', "projectID=$bug->project"), $bug->projectName, '', "data-app='project'");?></td>
                </tr>
                ...
                <tr>
                  ...
                  <td><?php if($bug->execution) echo html::a($this->createLink('execution', 'browse', "executionID=$bug->execution"), $bug->executionName, '', "data-app='execution'");?></td>
                </tr>
                <?php endif;?>
                <tr class='nofixed'>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    {
                        echo ($canViewMR ? html::a($this->createLink('mr', 'view', "MRID=$MRID"), "#$MRID $linkMRTitle", '', 'data-app="devops"') : "#$MRID $linkMRTitle") . '<br />';
                    }
                    ?>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    ...
                    foreach($linkCommits as $commit)
                    {
                        ...
                        echo "<div class='link-commit' title='$commitTitle'>" . ($canViewRevision ? html::a($this->createLink('repo', 'revision', "repoID={$commit->repo}&objectID=0&revision={$commit->revision}"), $revision, '', 'data-app="devops"') . " $commit->comment" : $commitTitle) . '</div>';
                    }
                    ?>
                  </td>
                </tr>
