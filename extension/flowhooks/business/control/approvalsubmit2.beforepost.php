...
$oldDepts = $this->dao->select('dept')->from('zt_flow_business')->where('id')->eq($dataID)->fetch('dept');
$depts[]  = $createdDept;
...
{
    $checkResult = $this->flow->checkDevelopmentBudget($_POST['project'], $_POST['developmentBudget'], $dataID);
