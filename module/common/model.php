...
EOF;
    ...
    public static function buildIconButton($module, $method, $vars = '', $object = '', $type = 'button', $icon = '', $target = '', $extraClass = '', $onlyBody = false, $misc = '', $title = '', $programID = 0, $extraEnabled = '')
    {
        ...
        if(empty($title))
        {
            ...
            if($module == 'execution' && $method == 'unlinkStory' && isset($object->type) && $object->type == 'requirement') $title = str_replace($lang->SRCommon, $lang->URCommon, $lang->execution->unlinkStory);
        }
