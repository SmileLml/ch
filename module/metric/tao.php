...
class metricTao extends metricModel
{
     ...
     * @return array
     */
    protected function fetchMetricRecords(string $code, array $fieldList, array $query = array(), $pager = null): array
    {
     ...
     * @return array
     */
    protected function fetchLatestMetricRecords(string $code, array $fieldList, array $query = array(), $pager = null): array
    {
